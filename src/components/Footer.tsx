    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Campus Gathering</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Your one-stop platform for campus events and community building.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/events" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary">
                  Events
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-500 dark:text-gray-400">
                Email: contact@campusgathering.com
              </li>
              <li className="text-sm text-gray-500 dark:text-gray-400">
                Phone: (123) 456-7890
              </li>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-6 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Campus Gathering. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
