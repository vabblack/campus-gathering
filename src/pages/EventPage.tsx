  ...
  return (
    <div className="min-h-screen bg-black">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="glass-card p-6 md:p-8 animate-fade-in backdrop-blur-xl bg-black/40 border border-white/10 shadow-2xl rounded-lg">
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="glass-card p-6 rounded-lg border border-yellow-400/20 backdrop-blur-xl bg-black/60">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedEvents.map((event) => (
                <Link key={event.id} to={`/event/${event.id}`}>
                  <div className="glass-card p-4 rounded-lg border border-yellow-400/20 backdrop-blur-xl bg-black/60 hover:border-yellow-400/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
